...
function vacios_plan(){

	if($('#tipoe').val() == "0" || $('#desc').val() == "" || $('#costo').val() == "" || $('#costom').val() == ""){
	  $('#btnG').prop( "disabled", true ); 
	  document.getElementById('btnG').style.background  = "black";		
	  document.getElementById('vacio').style.display  = "block";
	  }else{
	  $('#btnG').prop( "disabled", false ); 
		  document.getElementById('btnG').style.background  = "#3c8dbc";

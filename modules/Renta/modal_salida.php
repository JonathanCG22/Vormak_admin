    ...
    if ($_SESSION['permisos_acceso'] <= $max && $_SESSION['permisos_acceso'] != 0) { 
      ...
      if ($val > 0) { ?>
        <a class="btn btn-primary btn-social pull-right"   data-toggle="modal" data-target="#ModalAdd" title="Agregar Renta">
          <i class="fa fa-plus" style="padding: 6px; height: unset;"></i> Agregar Folio
        </a>
    ...
    <div class="col-md-12">
      ...
      <div class="box box-teal-primario">
            ...
            <table id="pruebas" class="table table-bordered table-striped table-hover table-condensed" width="100%">
              <thead align="center">
                ...
                <th class="text-center" width="5%">FOLIO</th>
                  <th class="text-center" width="5%">Descripcion</th>
                  <th class="text-center" width="5%">Transacciones totales:</th>
              ...
              ?>
                      <tr>
                          ...
                          <td align='center' width="5%"><?php echo $data['Descripcion']; ?></td>                                  <!--EDITADO-->
        ...
        <div class="modal fade" id="ModalAdd" data-backdrop="static">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">AGREGAR FOLIO</h4>
                </div>
                <div class="modal-body" onchange="camposVacios(0);">
                  <form class="form-horizontal" method="POST" action="modules/Renta/proses.php?act=crear_folio">

                    <div class="box-body" onclick="inicioEvent(0);" oninput="ocultarPrefijo(0);">

                  
                  <div class="form-group">
                  <label for="title" class="col-sm-4 control-label">FOLIO:</label>
                  <div class="col-sm-7">
                 <input type="text" id="folio" name="folio" value="1" class="form-control" required="required" maxlength="15" disabled>
                 </div>
                 </div>    
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-7">
                 <input type="text" id="descripcion" name="descripcion" class="form-control" required="required" maxlength="25" >
                 </div>
                 </div> 

                 <div class="form-group">
                  <label for="title" class="col-sm-4 control-label">Equipos Requeridos:</label>
                  <div class="col-sm-7">
                 <input type="int" id="equiposrequeridos" name="equipos" class="form-control" required="required" maxlength="11" >
                 </div>
                 </div> 
          ...
          <!-- Modal addSalida -->
          <div class="modal fade" id="ModalAddSalida" data-backdrop="static">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                  ...
                  <form class="form-horizontal" method="POST" action="modules/Renta/proses.php?act=insert_renta">
                    ...
                    <div class="form-group" >
                      <label for="title" class="col-sm-4 control-label">Equipo:</label>
                        <div class="col-sm-7"  >
                        <SELECT class="form-control" id="lista1"  NAME="lista1" maxlength="5" onchange="recargarLista();"> 
                        <?php  
                      ...
                      <OPTION value="<?php echo $dat['ID_Tipo']."*".$dat['NE']; ?>"><?php echo $dat['NE'];?>&nbsp;&nbsp;&nbsp;<?php echo $dat['Descripcion'];?></OPTION>
        ...
        <div class="col-sm-7">
        <input type="date" id="fechai" name="fechainicio" class="form-control" required="required" maxlength="15">
        </div>
        </div>

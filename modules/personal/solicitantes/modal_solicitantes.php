...
<section class="content-header">
  <h1>
    <i class="fa fa-user icon-title" title="Agregar"></i> <span id="titulo">Datos del solicitante </span>

  <?php //  <a class="btn btn-primary btn-social pull-right" id="button" title="Agregar Personal" data-toggle="modal" data-target="#ModalAddPersonal" title="Agregar" data-toggle="tooltip">
...
?>
    ...
    <?php /*<a class='btn btn-primary pull-right' onclick="openModal(null, 'agregar_salida', 'R4')"  title='Solicitudes andamieros' data-toggle='tooltip' target='_blank' style="margin-right: 5px;">
      ...
      <div class="box box-teal-primario">
        <div class="box-body">
          ...
          <table id="tabla1" class="table table-bordered table-striped table-hover table-condensed">
            ...
            <?php
            $fecha = date('Y-m-d');
            $query = $crud->consulta_Personal_solicitante();
